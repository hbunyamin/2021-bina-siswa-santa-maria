...
\begin{table}[!ht]
	...
	\end{tabular}	
\end{table}
\onslide<22->{Bilangan yang dicari adalah} 
\begin{align*}
...
\begin{frame}{Solusi (2/4)}
	\begin{align*}
((4^8 + 4^7 + 4^6 + 4^5 +4^4 +4^3 + 1) \times 4^2 ) \mod  31 &=  \\
\onslide<2->{(\underbrace{(4^8 + 4^7 + 4^6 + 4^5 +4^4 +4^3 + 1) \mod 31}_{\text{Bagian I}}  & \times (4^2  \mod 31) ) \mod  31 }
	\end{align*}
	\onslide<3->{Jadi di Bagian I ada} 
	\begin{align*}
		\onslide<4->{4^8 \mod 31 &=}  \onslide<5->{( 4^4 \times 4^4 ) \mod 31}  \\
		            \onslide<6->{&= ((4^4 \mod 31) \times (4^4 \mod 31)) \mod 31}  \\
		            \onslide<7->{&= (8 \times 8) \mod 31}  \\
				    \onslide<8->{&= 2}  \\
				    & \\
		\onslide<9->{4^7 \mod 31 &=}  \onslide<10->{(4^3 \times 4^4) \mod 31}  \\
		                   \onslide<11->{&= ( (4^3 \mod 31 ) \times (4^4 \mod 31) ) \mod 31}  \\
		                   \onslide<12->{&= (2 \times 8) \mod 31}  \\
		                   \onslide<13->{&= 16.} 
	\end{align*}
\end{frame}

\begin{frame}{Solusi (3/4)}
	Kemudian,
\begin{align*}
	\onslide<2->{4^6 \mod 31 &=}  \onslide<3->{(4^3 \times 4^3) \mod 31}  \\
	\onslide<4->{&= ( (4^3 \mod 31) \times (4^3 \times 31) ) \mod 31}  \\
	\onslide<5->{&= 4.}  \\
	& \\
	\onslide<6->{4^5 \mod 31 &=}  \onslide<7->{(4^4 \times 4^1) \mod 31}  \\
	            \onslide<8->{&= ( (4^4 \mod 31) \times ( 4^1 \mod 31 )) \mod 31}  \\
	            \onslide<9->{&= (8 \times 4)  \mod 31}  \\
	            \onslide<10->{&= 1.} 
\end{align*}
	\onslide<11->{Sisanya:}
	\begin{align*}
		\onslide<12->{4^4 \mod 31 &= 8}  \\
		\onslide<13->{4^3 \mod 31 &= 2 \text{ dan }1.}                         
	\end{align*}	
\end{frame}

\begin{frame}{Solusi (4/4)}
	\onslide<2->{Jadi Bagian I menjadi} 
\begin{align*}
	\onslide<3->{(4^8 + 4^7 + 4^6 + 4^5 +4^4 +4^3 + 1) \mod 31 &=}  \\
	\onslide<4->{(2 + 16 + 4 + 1 + 8 + 2 + 1) \mod 31 &= }  \\
	\onslide<5->{34 \mod 31 &=}  \onslide<6->{3.}	
\end{align*}
\onslide<7->{Jadi total semua adalah} 
\begin{align*}
	\onslide<8->{( \underbrace{3}_{\text{Bagian I}} \times (4^2 \mod 31)) \mod 31 &= ( 3 \times (16 \mod 31)) \mod 31}  \\
	\onslide<9->{&= ( 3 \times 16 ) \mod 31}  \\ 
	\onslide<10->{&= 17.}   
\end{align*}	
\onslide<11->{Jadi hasil akhirnya adalah 17.} 
\end{frame}
